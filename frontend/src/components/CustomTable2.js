...
const CustomTable2 = ({ members, onRowClick, onEdit, onView, onDelete }) => {
      ...
      <Table style={{ borderCollapse: 'separate', cursor: 'pointer' }}>
        <TableHeadStyled>
          <TableRow>
            ...
            <TableCell style={{  }}>Association</TableCell>
            ...
            <TableRowStyled key={member.id}>
              ...
              <TableCell style={{ textAlign: 'center' }}>
                <Select
                  ...
                  size="small"
                  fullWidth
                  onChange={(e) => handleEdit(member.id, { ...member, role: e.target.value })}
              ...
              >
                <Select
                  ...
                  style={{ minWidth: '100px', fontWeight: 'bold', color: getStatusColor(member.status) }}
                >
              ...
              <TableCell style={{ minWidth: '240px' }}>{member.association}</TableCell>
