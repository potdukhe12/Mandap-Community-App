                ...
                <Box component="main" sx={styles.boxStyled}>
                    <Box sx={{ 
                        ...
                        <Routes>
                            ...
                            {/* <Route path="/Admin/association/:id/details" element={<AssociationDetailsCard />} /> */}
                            
                            <Route path="/Admin/members" element={<Members />} />
                            <Route path="/Admin/members/:id" element={<MemberDetails />} />
                            <Route path="/Admin/community" element={<SeeComplains />} />
                            <Route path="/Admin/members" element={<SeeComplains />} />
                            <Route path="/Admin/details" element={<SeeComplains />} />                            
